...
import classes from './FAQCardSelections.module.css';
import PinkForwardArrow from '../../../assets/Group 34-pink.svg';

function FAQCardSelections({changeBorderRadius}) {
    const [isVisible, setIsVisible] = useState(false);

  return (
    <div style={changeBorderRadius ? {borderRadius: '50px'} : {}} className={classes.FAQSectionCard}>
...
export default FAQCardSelections;