...
function CustomRightLargeArrow ({onClick, changesForExpertise, changesForTeammates, changesForHome}) {
    ...
    return (
    <>
        <div style={changesForExpertise ? {height:'687px'} : {} && changesForTeammates ? {height:'1090px'} : {} && changesForHome ? {height:'830px', width: '198px'} : {}} className={classes.customRightLargeArrowBody}>
